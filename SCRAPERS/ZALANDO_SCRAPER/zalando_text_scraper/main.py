...
def main():
    ...
    links = ["https://www.zalando.fr/luxe-femme/","https://www.zalando.fr/chaussures-femme/","https://www.zalando.fr/mode-femme/","https://www.zalando.fr/sport-femme/"]
    for link in links:
        ...
        data = scraper.scrape(max_pages=2,half_of_last_page = False)
